# Java程序的基本结构练习：创建一个实例方法

请补全[Cat](https://github.com/hcsp/create-a-instance-method/blob/master/src/main/java/com/github/hcsp/pet/Cat.java)中的实例方法。在提交Pull Request之前，你应当在本地确保所有代码已经编译通过，并且通过了测试(`mvn clean verify`)
